...
import {StyledButton, StyledTextButton} from "@/src/shared/StyledButton";

const Header = () => {
    return <View style={style.header}>
        <View>
            <StyledText theme={'dark'}>Добро пожаловать 👋</StyledText>
            <StyledText theme={'dark'} fontSize={'3xl'} style={{marginTop: 8, fontWeight: '600'}}>Мои финансы</StyledText>
        </View>
    </View>
}
    ...
    return <View style={{rowGap: 20, paddingBottom: 40}}>
        <Card>
            <View style={{
                ...
                <View>
                    ...
                    <StyledText fontSize={'4xl'} style={{fontWeight: '700'}}>₴80 000</StyledText>
                </View>
            ...
            <View style={{flexDirection: 'row'}}>
                <View style={{
                    ...
                    <StyledText fontSize={'2xl'} style={{fontWeight: '700'}}>₴80 000</StyledText>
                </View>
                <View style={{
                    flex: 1,
                    rowGap: 10
        ...
        >
            <Card backgroundColor={'blue'} offset={'md'} style={{flex: 1, rowGap: 8, minWidth: 200}}>
                ...
                <StyledText fontSize={'2xl'} theme={'dark'} style={{fontWeight: '700'}}>₴80 000</StyledText>
            </Card>
        ...
        <View style={{rowGap: 20}}>
            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <StyledText fontSize={'xl'} style={{fontWeight: '600'}}>Последние операции</StyledText>
            ...
            <Card offset={'md'}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    <View style={{flexDirection: 'row', alignItems: 'center', columnGap: 15}}>
                        ...
                        <View>
                            <StyledText fontSize={'xl'} style={{fontWeight: '600'}}>Продукты</StyledText>
                            <StyledText color={'secondary'}>25 ноя.</StyledText>
                        </View>
                    </View>
                    <StyledText fontSize={'xl'} style={{fontWeight: '700'}}>- 80 000 ₴</StyledText>
                </View>
            </Card>
            <Card offset={'md'}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
